...
def stack_predict_v2(input_imgpath, 
    ...
    for idx in trange(len(input_imgpath)):
        ...
        img_tmp = img_tmp.reshape(1, img_tmp.shape[0], img_tmp.shape[1], 1)
        ...
        img_predict = model.predict(img_tmp, batch_size = 16, verbose = 1)
        
        # threshold the image
        outputimg_T = img_predict > predict_threshold
